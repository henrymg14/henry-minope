...
import 'app/components/auto/AddAutoForm.css';
...
const AddAutoForm = ({
    ...
    return (
        <div className="addAutoForm-container">
            <div className="addAutoForm-title">Add Auto</div>
            <Form noValidate onSubmit={onSubmit} className="addAutoForm-inputs">
                <Row>
                    <Col sm={6}>
                ...
                <Row className="addAutoForm-buttons">
                    <Button type="submit" className="addAutoForm-btn-add">
                        Add
                    </Button>
                    <Link to="/autoList" className="addAutoForm-btn-cancel">
                        Cancel
                    </Link>
                </Row>
            </Form>
