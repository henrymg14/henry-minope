...
import 'app/components/trabajador/EditTrabajadorForm.css';

const EditTrabajadorForm = ({
    trabajador,
    validated,
    onChange,
    onSubmit
    ...
    return (
        <div className="editTrabajadorForm-container">
            <div className="editTrabajadorForm-title">Edit Trabajador</div>
            <Form noValidate onSubmit={onSubmit} className="editTrabajadorForm-inputs">
                <Row>
                    <Col sm={6}>
                ...
                <Row className="editTrabajadorForm-buttons">
                    <Button type="submit" className="editTrabajadorForm-btn-edit">
                        Update
                    </Button>
                    <Link to="/trabajadorList" className="editTrabajadorForm-btn-cancel">
                        Cancel
                    </Link>
                </Row>
            </Form>
...
export default EditTrabajadorForm;