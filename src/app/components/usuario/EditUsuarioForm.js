...
import 'app/components/usuario/EditUsuarioForm.css';
...
const EditUsuarioForm = ({
    ...
    return (
        <div className="editUsuarioForm-container">
            <div className="editUsuarioForm-title">Edit Usuario</div>
            <Form noValidate onSubmit={onSubmit} className="editUsuarioForm-inputs">
                <Row>
                    <Col sm={6}>
                ...
                <Row className="editUsuarioForm-buttons">
                    <Button type="submit" className="editUsuarioForm-btn-edit">
                        Update
                    </Button>
                    <Link to="/usuarioList" className="editUsuarioForm-btn-cancel">
                        Cancel
                    </Link>
                </Row>
            </Form>
